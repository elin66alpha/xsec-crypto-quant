...
### 6. `[x]` 三段切分日期已过时（commit eb4ed26：SplitConfig 更新为 IS 2020-01~2024-06 / VAL 2024-07~2025-09 / holdout 2025-10 起锁定，claude-lead 实现）
...
### 11. `[-]` 无操作带假设"不调仓 = 权重不变"，忽略持仓漂移（2026-06-11 决定：日频下二阶小量，记录在案；#5 缓冲带已落地，是否建模漂移待阶段 5 真实数据实测换手后评估）
